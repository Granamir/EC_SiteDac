...
function executeIndexJS() {
    console.log('index.js foi carregado e está sendo executado!');

    // Adicione aqui as funções ou lógica que devem ser executadas
    fetchAndDisplayNFTs();
...
async function fetchAndDisplayNFTs() {
    ...
    // Sua lógica de fetch para NFTs
}

async function fetchAndDisplayTransactions() {
    console.log('Fetching Transactions data...');
    // Sua lógica de fetch para Transações
}
